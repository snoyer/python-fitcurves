...
// #define MAX_POINTS	1000		/* The most points you can have */

extern void DrawBezierCurve(int n, BezierCurve curve, void* surface);
 ...
 */
void FitCurve(d, nPts, error, MAXPOINTS, DrawBezierCurve, surface)
    Point2	*d;			/*  Array of digitized points	*/
    int		nPts;		/*  Number of digitized points	*/
    double	error;		/*  User-defined error squared	*/
    unsigned long MAXPOINTS;	/* The most points you can have */
    void (*DrawBezierCurve)(int, BezierCurve, void* surface);
    void* surface;
{
    Vector2	tHat1, tHat2;	/*  Unit tangent vectors at endpoints */
    tHat1 = ComputeLeftTangent(d, 0);
    tHat2 = ComputeRightTangent(d, nPts - 1);
    FitCubic(d, 0, nPts - 1, tHat1, tHat2, error, MAXPOINTS, DrawBezierCurve, surface);
}
 ...
 */
static void FitCubic(d, first, last, tHat1, tHat2, error, MAXPOINTS, DrawBezierCurve, surface)
    Point2	*d;			/*  Array of digitized points */
    ...
    void* surface;
{
    ...
    if (nPts == 2) {
		...
		DrawBezierCurve(3, bezCurve, surface);
		free((void *)bezCurve);
		return;
    }
    ...
    bezCurve = GenerateBezier(d, first, last, u, tHat1, tHat2, MAXPOINTS);
    ...
    if (maxError < iterationError) {
		for (i = 0; i < maxIterations; i++) {
	    	...
	    	free((void *)bezCurve);
	    	bezCurve = GenerateBezier(d, first, last, uPrime, tHat1, tHat2, MAXPOINTS);
    ...
    FitCubic(d, first, splitPoint, tHat1, tHatCenter, error, MAXPOINTS, DrawBezierCurve, surface);
    V2Negate(&tHatCenter);
    FitCubic(d, splitPoint, last, tHatCenter, tHat2, error, MAXPOINTS, DrawBezierCurve, surface);
}
 ...
 *
 */
static BezierCurve  GenerateBezier(d, first, last, uPrime, tHat1, tHat2, MAXPOINTS)
    Point2	*d;			/*  Array of digitized points	*/
